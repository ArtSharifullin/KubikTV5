...
/// <summary>
/// Представляет парсер выражений для построения SQL-запросов.
/// </summary>
/// <typeparam name="T">Тип сущности.</typeparam>
public static class ExpressionParser<T>
{
    /// <summary>
    /// Разбирает выражение и преобразует его в строку SQL-запроса.
    /// </summary>
    ...
    /// <summary>
    /// Получает SQL-оператор на основе типа узла выражения.
    /// </summary>
